(function(){
  ...
  function showTestPrompt(){
    ...
    box.innerHTML='<img src="./icons/fyblic-app-icon-v1042-96.png" alt="Fyblic"><div class="haPushText"><b>Tester hors application</b><span>Touchez Tester, puis fermez Fyblic et Chrome. La notification doit arriver dans 12 secondes.</span></div><div class="haPushActions"><button class="haPushEnable" type="button">Tester</button><button class="haPushClose" type="button" aria-label="Fermer">×</button></div>';
