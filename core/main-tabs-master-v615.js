  ...
  function activate(page,extra){
    ...
    try{
      ...
      if(n&&typeof n.open==='function'){
        var urls={video:'modules/video.html',message:'modules/message-center.html?mode=inbox&source=v738-assistance&v=1026-avatar-cover',profile:'modules/my-profile.html?v=1001-profile-identity-scale',publish:'modules/publish.html?v=1119-media-preview-robuste'};
