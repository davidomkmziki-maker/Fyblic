...
var HAPPYAD_SW_VERSION = 'fyblic-pwa-v1042-brand-icon-20260915';
...
var HAPPYAD_APP_SHELL = [
  './',
  './index.html',
  './index.html?v=v1042-brand-icon',
  './manifest.webmanifest',
  './core/fyblic-system-theme-v1022.css?v=1022-world-theme',
  './icons/fyblic-app-icon-v1042-96.png',
  './icons/fyblic-app-icon-v1042-192.png',
  './icons/fyblic-app-icon-v1042-512.png',
...
function happyadPushPayload(event){
  var fallback={
    ...
    icon:'./icons/fyblic-app-icon-v1042-192.png',
    badge:'./icons/fyblic-app-icon-v1042-96.png',
...
function happyadPrepareMessageAvatar(data,detail){
  var logo=happyadNotificationAsset('./icons/fyblic-app-icon-v1042-192.png','./icons/fyblic-app-icon-v1042-192.png');
...
function happyadNotificationOptions(data,detail,preparedIcon,withActions){
  var logo=happyadNotificationAsset('./icons/fyblic-app-icon-v1042-192.png','./icons/fyblic-app-icon-v1042-192.png');
  var badge=happyadNotificationAsset(data.badge||'./icons/fyblic-app-icon-v1042-96.png','./icons/fyblic-app-icon-v1042-96.png');
