...
var HAPPYAD_SW_VERSION = 'fyblic-pwa-v1067-progress-under-radar-20260921';
...
var HAPPYAD_APP_SHELL = [
  ...
  './modules/publish.html?v=1067-progress-under-radar',
  './core/media-compression-client-v1.js?v=1067-compression-lock',
  './core/publication-pipeline-v2.js?v=1067-stale-job-cleanup',
  './core/publication-background-ui-v2.js?v=1067-under-radar-inline',
